...
--
-- Host: 127.0.0.1
-- Tempo de geração: 10/10/2023 às 16:47
...
--
CREATE DATABASE IF NOT EXISTS `microblog_andre` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `microblog_andre`;
...
(1, 'Plínio', 'xpto@ok.com', '$2y$10$yzpdXwCdAte0MlebaT0mDuqn/CXmksucis52aFEaHeBZMnF4ZEjWW', 'editor'),
(2, 'Pocotó', 'minhoca@xpto.com', '$2y$10$p.prfz2SkxHvnh0bckl.AuFFElWnpHFuRRVitnlkzKxOjP3E/j5S6', 'admin'),
(3, 'Ademir', 'admin@admin.admin', '$2y$10$YV2PwtGK9LQRjbspgwLG8OnVeUNUfoBLNK1THmr7suj92pfOs2hoe', 'admin');
